...
class RhinoDiagramObject(DiagramObject, RhinoMeshObject):
    ...
    #         message=message, preselect=True, select=True, filter=pointfilter
    #     )
    ...
    #     guid = compas_rhino.rs.GetObject(
    #         message=message, preselect=True, select=True, filter=curvefilter
    #     )
    ...
    #                 Point3d(*vertex_xyz[u]), Point3d(*vertex_xyz[v]), color
    #             )
    ...
    #         nbrs = [
    #             Point3d(*vertex_xyz[nbr])
    #             for nbr in diagram.vertex_neighbors(vertex)
    #             if diagram.edge_attribute((vertex, nbr), "_is_edge")
    #         ]
    #     else:
    #         nbrs = [
    #             Point3d(*vertex_xyz[nbr]) for nbr in diagram.vertex_neighbors(vertex)
    #         ]
    ...
    #     angle_rotation = -self.rotation[2]  # rotate the inverse of the transformation
    #     point = list(gp.Point())
    #     point = rotate_points_xy([point], angle_rotation)[0]
    #     xyz0 = vertex_xyz[vertex]
    #     xyz0 = rotate_points_xy([xyz0], angle_rotation)[0]
    ...
    #         for nbr in nbrs:
    #             if (
    #                 "_is_edge" in diagram.default_edge_attributes
    #                 and not diagram.edge_attribute((vertex, nbr), "_is_edge")
    #             ):
    #                 continue
    #             b = vertex_xyz[nbr]
    ...
    #     angle_rotation = -self.rotation[2]  # rotate the inverse of the transformation
    #     end = rotate_points_xy([end], angle_rotation)[0]
    #     start = rotate_points_xy([start], angle_rotation)[0]
    #     dxyz0 = subtract_vectors(end, start)
    #     dxyz = scale_vector(dxyz0, 1 / self.scale)
    #     for vertex in vertices:
    #         xyz = diagram.vertex_attributes(vertex, "xyz")
    #         xyz[:] = add_vectors(xyz, dxyz)
